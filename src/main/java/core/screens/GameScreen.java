...
import core.screens.gamescreen.MiddleGame;
import core.screens.gamescreen.PauseGame;
...
/*public class GameScreen extends ScreenAdapter {
    ...
    public void render(float delta) {
        switch (gameState){
            ...
            case RUNNING:
                new MiddleGame(camera, level).render(delta);
                break;

            case PAUSED:
                pauseGame.render(delta);
                break;
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.P)) gameState = GAME_STATE.PASSED;
        if (Gdx.input.isKeyPressed(Input.Keys.O)) gameState = GAME_STATE.RUNNING;
